        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <a href="http://localhost:5173/login" target="_blank" rel="noopener noreferrer" className="no-underline">
                <Button size="lg" className="bg-[#002c5f] hover:bg-[#002c5f]/90 text-white font-medium rounded-full px-8">
                  <LogIn className="mr-2 h-5 w-5" />
                  Se connecter
                </Button>
              </a>
              <a href="mailto:contact@portflow.com" className="no-underline">
                <Button variant="outline" size="lg" className="border-[#002c5f] text-[#002c5f] hover:bg-[#002c5f]/10 font-medium rounded-full px-8">
                  Nous contacter
                </Button>
              </a>
            </div>
